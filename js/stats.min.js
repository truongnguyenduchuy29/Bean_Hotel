(function () {
    ...
    if (
      ((i === "checkout_contact_view" ||
        ...
        (n.content_ids = Bizweb.Checkout.fbEvent
          ...
          : []),
        (n.metadata.num_items = Bizweb.Checkout.fbEvent
          ? Bizweb.Checkout.fbEvent.num_items
          : 0),
        (n.contents = Bizweb.Checkout.fbEvent
          ? Bizweb.Checkout.fbEvent.contents
          : [])),
      ...
      n.contents = [
        Object.assign({}, f, { item_price: f.price }, { price: null }),
      ];
    }
    t.postData(c, n, u, r);
  }
  ...
  function vt() {
    ...
    Bizweb.checkout.customer_id &&
      (n.metadata.external_id = Bizweb.checkout.customer_id.toString());
    Bizweb.checkout.customer_first_name &&
      (n.metadata.customer_first_name = Bizweb.checkout.customer_first_name);
    Bizweb.checkout.customer_first_name &&
      (n.metadata.customer_last_name = Bizweb.checkout.customer_last_name);
    Bizweb.checkout.customer_phone &&
      (n.metadata.customer_phone = Bizweb.checkout.customer_phone);
  ...
  n = {
    ...
    metadata: {
      ...
      external_id:
        BizwebAnalytics.meta && BizwebAnalytics.meta.customer
          ? BizwebAnalytics.meta.customer.id
          : null,
      customer_first_name:
        BizwebAnalytics.meta && BizwebAnalytics.meta.customer
          ? BizwebAnalytics.meta.customer.first_name
          : null,
      customer_last_name:
        BizwebAnalytics.meta && BizwebAnalytics.meta.customer
          ? BizwebAnalytics.meta.customer.last_name
          : null,
      customer_phone:
        BizwebAnalytics.meta && BizwebAnalytics.meta.customer
          ? BizwebAnalytics.meta.customer.phone
          : null,
    },
    email:
      BizwebAnalytics.meta && BizwebAnalytics.meta.customer
        ? BizwebAnalytics.meta.customer.email
        : null,
  };
  ...
  a.prototype.handleXhrDone = function (i) {
    ...
    try {
      switch (i.url) {
        case "/cart/add.js":
          i.xhr.responseText &&
            ((e = JSON.parse(i.xhr.responseText)),
            ...
            (n.fb_event_id =
              Bizweb.fbEventId + (o ? new Date(o).getTime() : null)),
            t.postData(c, n, u, r),
          ...
          try {
            switch (i.url) {
              case "/cart/add.js":
                ...
                n.fb_event_id =
                  Bizweb.fbEventId + (e ? new Date(e).getTime() : null);
                n.session_type = "add_to_cart";
                n.active_session = !0;
                t.postData(c, n, u, r);
                n.variant_id = t.getParamValue("variantId", i.body);
