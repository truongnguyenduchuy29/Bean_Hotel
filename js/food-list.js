                    ...
                    <div class="item_product_main">
                        <form action="/cart/add" method="post" class="variants product-action" enctype="multipart/form-data">
                            <div class="product-thumbnail">
                                <a class="image_thumb" href="/${item.url}" title="${item.name}">
                                ...
                                <div class="group_action">
                                    ...
                                    <a title="Xem nhanh" href="/${item.url}" data-handle="${item.url}" class="btn-anima hidden-xs xem_nhanh btn-circle btn-views btn_view btn right-to quick-view">
