...
Bizweb.SearchFilter = (function () {
    ...
    SearchFilter.prototype.deleteValuedqdt = function (
        group,
        field,
        value,
        operator
    ...
    SearchFilter.containsOperator = function (value) {
        if (value.indexOf(Bizweb.SearchOperators.OR) > 0) return true;

        if (value.indexOf(Bizweb.SearchOperators.AND) > 0) return true;
